 ...
 *
 * ClaudiaLogs.Derive.indexerParseRootScopes(jsonString | array)
 * ClaudiaLogs.Derive.indexerExtractRunTargetsByRunId(entryCache, getFlat)
 * ClaudiaLogs.Derive.indexerBucketGidsForLine(flat, st)
 * ClaudiaLogs.Derive.indexerBucketsFromCache(entryCache, getFlat)
 */
...
function indexerGroupKeyFromFlatImport(fl) {
  if (globalThis.ClaudiaLogs && ClaudiaLogs.Derive && typeof ClaudiaLogs.Derive.indexerGroupKeyFromFlat === "function") {
    return String(ClaudiaLogs.Derive.indexerGroupKeyFromFlat(fl) || "").trim();
  }
  var ik =
...
globalThis.ClaudiaLogs.Derive.indexerParseRootScopes = indexerParseRootScopes;
globalThis.ClaudiaLogs.Derive.indexerExtractRunTargetsByRunId = indexerExtractRunTargetsByRunId;
globalThis.ClaudiaLogs.Derive.indexerBucketGidsForLine = indexerBucketGidsForLine;
globalThis.ClaudiaLogs.Derive.indexerBucketsFromCache = indexerBucketsFromCache;
