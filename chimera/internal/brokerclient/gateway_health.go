...
// supervisedChildHealthState tracks gateway.health.chimera-broker / gateway.health.chimera-vectorstore (P4).
...
// gateway.health.{child} when HTTP health flips (child must be "chimera-broker" or "chimera-vectorstore").
