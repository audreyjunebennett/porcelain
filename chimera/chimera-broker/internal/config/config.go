...
func bindFlags(fs *flag.FlagSet, cfg *Config) {
	...
	fs.BoolVar(&cfg.DebugEnableUpstream, "debug-enable-broker-logs", wruntime.EnvBool(contract.DebugEnableEnvKey(contract.ComponentBroker)), "enable "+contract.DebugBrokerLogsPath)
