 ...
 *
 * Exports:
 * - ChimeraSettings.Transport.init(ctx)
 *
...
function init(ctx) {
  /** Prevent stacked listeners + duplicate EventSource if ChimeraSettings.Main ran more than once (e.g. stray re-entry). */
...
globalThis.ChimeraSettings.Transport = { init: init, stop: stopTransport };
