...
(function () {
  ...
  var bySlug = {
    ...
    "conversation.rag.attached": {summary: "Retrieved chunks were injected into the chat request as context."},
    ...
    "vectorstore.http.upsert.summary": {summary: "chimera-lynn-porcelain · 42 upsert(s) · last 5s", formatter: "vectorstore_http_upsert_summary"},
    ...
    "indexer.storage.stats": {summary: "Stored indexes look healthy — 1204 embedded text chunk(s) are ready for retrieval", formatter: "indexer_storage_stats"},
    ...
    "indexer.queue.snapshot": {summary: "Ingest workers idle · embed queue empty · 0 files embedded this run", formatter: "indexer_queue_snapshot"},
    ...
    "indexer.job.skipped.summary": {summary: "Checked 1476 files in the last 5 seconds — everything was already indexed, so nothing new was embedded", formatter: "indexer_job_skipped_summary"},
    "indexer.retry.scheduled": {summary: "Retry scheduled · src/main.go · attempt 2 · backoff 500 ms", formatter: "indexer_retry_recovery"},
    "indexer.recovery.poll": {summary: "Recovery poll #3 · storage OK · embed OK", formatter: "indexer_retry_recovery"},
    "indexer.recovery.resumed": {summary: "Ingest ready — resuming workers"},
    "indexer.ingest.gate.closed": {summary: "Ingest paused — embed provider down · queue 42", formatter: "indexer_ingest_gate"},
