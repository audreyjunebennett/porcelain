 ...
 * ChimeraLogs.Derive.indexerFlatMsg(flat) — registry resolveFlat (slog duplicate msg keys)
 * ChimeraLogs.Derive.indexerProseSummary(flat) — registry operatorMessage; null → caller fallback
 */
...
function indexerProseSummary(flat) {
  ...
  var render = globalThis.ChimeraLogs && ChimeraLogs.Render;
