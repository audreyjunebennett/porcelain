...
globalThis.ChimeraLogs.Summarized.Model = globalThis.ChimeraLogs.Summarized.Model || {};

(function () {
  var Render = globalThis.ChimeraLogs.Summarized.Render;
  var Hash = globalThis.ChimeraLogs.Summarized.Hash;
  ...
  function buildServiceCards(cards, agg, deps) {
    var order =
      globalThis.ChimeraLogs.Summarized.SERVICE_BUCKET_ORDER ||
  ...
  globalThis.ChimeraLogs.Summarized.Model.buildSummarizedModel = buildSummarizedModel;
  globalThis.ChimeraLogs.Summarized.Model.makeCard = makeCard;
})();
