 ...
 *
 * Exports:
 * - ChimeraLogs.Derive.gatewayCardModel(arr, getFlat)
 * - ChimeraLogs.Derive.gatewayPanelHideRow(ent, getFlat)
 *
...
function gatewayCardModel(arr, getFlat) {
  ...
  getFlat = typeof getFlat === "function" ? getFlat : function (p) { return (p && p.rawFlat) || {}; };
  var S = globalThis.ChimeraLogs && ChimeraLogs.OperatorCopy && ChimeraLogs.OperatorCopy.Slug;
...
globalThis.ChimeraLogs.Derive.gatewayCardModel = gatewayCardModel;
globalThis.ChimeraLogs.Derive.gatewayPanelHideRow = gatewayPanelHideRow;
