 ...
 *
 * Exports:
 * - ChimeraLogs.Derive.conversationRequestIdTier2Eligible(flat)
 * - ChimeraLogs.Derive.conversationIndexRunTier3Eligible(flat)
 * - ChimeraLogs.Derive.extractConversationQdrantJoinAnchors(events, getFlat)
 * - ChimeraLogs.Derive.joinQdrantLineConversationMatch(events, getFlat, qFlat, qTimeMs)
 * - ChimeraLogs.Derive.joinQdrantLineConversationTier(events, getFlat, qFlat, qTimeMs)
 * - ChimeraLogs.Derive.conversationTurnGroupsForExpanded(events, getFlat)
 * - ChimeraLogs.Derive.buildConversationCardModel(events, getFlat)
 */
...
globalThis.ChimeraLogs.Derive.conversationRequestIdTier2Eligible = conversationRequestIdTier2Eligible;
globalThis.ChimeraLogs.Derive.conversationIndexRunTier3Eligible = conversationIndexRunTier3Eligible;
globalThis.ChimeraLogs.Derive.extractConversationQdrantJoinAnchors = extractConversationQdrantJoinAnchors;
globalThis.ChimeraLogs.Derive.joinQdrantLineConversationMatch = joinQdrantLineConversationMatch;
globalThis.ChimeraLogs.Derive.joinQdrantLineConversationTier = joinQdrantLineConversationTier;
globalThis.ChimeraLogs.Derive.conversationTurnGroupsForExpanded = conversationTurnGroupsForExpanded;
globalThis.ChimeraLogs.Derive.buildConversationCardModel = buildConversationCardModel;
