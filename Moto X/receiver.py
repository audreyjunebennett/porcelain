...
# Load D:\Porcelain\.env if present (gitignored, holds HF_TOKEN and gateway creds)
try:
...
BASE_DIR = Path(os.environ.get("MOTOX_AUDIO_DIR", r"D:\Porcelain\Moto X\claudia_motoxaudio_data"))
