...
Operator vocabulary and refactor plan: [`plans/archive/chimera-gateway-refactor.md`](plans/archive/chimera-gateway-refactor.md).
...
\* Debug log ring buffers are disabled by default (`404`) unless explicitly enabled. Path rename across wrappers is tracked in [`plans/archive/chimera-gateway-refactor.md`](plans/archive/chimera-gateway-refactor.md) open questions.
