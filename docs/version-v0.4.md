...
| [Indexer Phase 7 — model-assisted strategy](#indexer-phase-7--model-assisted-strategy)     | Optional gateway-mediated indexing recommendations from tree + config summary ([`plans/archive/indexer.md`](plans/archive/indexer.md) Phase 7)                      | `todo`  |
...
**Companion docs:** [`chimera.plan.md`](chimera.plan.md) (requirements: *Ensemble orchestration*, *External human escalation*, *Responsibility split*, *Gateway runtime*, *Chat turn resilience and degradation*, *Workspace indexing and retrieval*, *Indexer live storage API*), [`configuration.md`](configuration.md), [`plans/archive/indexer.md`](plans/archive/indexer.md), [`plans/env-precedence-contract.md`](plans/env-precedence-contract.md) (unified env/config precedence), [`plans/archive/desktop-ui.md`](plans/archive/desktop-ui.md), [`plans/operator-cli.md`](plans/operator-cli.md) (operator CLI for gateway/BiFrost), [`plans/_template.md`](plans/_template.md).
...
* **Re-index** — Full re-index all workspaces on ship; coordinate with [`plans/archive/indexer-sync-state-sqlite-and-force-reindex.md`](plans/archive/indexer-sync-state-sqlite-and-force-reindex.md).
...
* **Execution plan:** [`plans/archive/indexer-embedding-model-and-workspace-purge.md`](plans/archive/indexer-embedding-model-and-workspace-purge.md) Phase 3 — workspace delete drops collection (may ship before full v0.4 purge UI).
...
**Execution plan:** [`plans/archive/indexer.md`](plans/archive/indexer.md) — **Phase 7 — Model-assisted strategy** (Phases 2–6 are **done**; Phase 7 is the remaining indexer plan item).
...
* [`plans/archive/indexer.md`](plans/archive/indexer.md) Phase 7 checklist item marked **done** when the normative contract and at least one operator path ship.
...
* **Keyboard / UX** — Sensible focus order and shortcut if the platform supports it (document in [`plans/archive/desktop-ui.md`](plans/archive/desktop-ui.md) when implemented).
...
* **Docs:** Update [`plans/archive/indexer.md`](plans/archive/indexer.md) and [`configuration.md`](configuration.md) when fields for project/flavor per index and per-request workspace lists are fixed.
...
* [`plans/archive/indexer.md`](plans/archive/indexer.md) - `chimera-indexer` plan (Phase 7 model-assisted strategy scoped to this release)
