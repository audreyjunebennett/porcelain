...
| **Originated from** | [`plans/archive/indexer-workspaces-sqlite-gateway-api.md`](../plans/archive/indexer-workspaces-sqlite-gateway-api.md), [`plans/archive/indexer-workspaces-accurate-reporting.md`](../plans/archive/indexer-workspaces-accurate-reporting.md) |
...
- Plans: [`plans/archive/indexer-workspaces-sqlite-gateway-api.md`](../plans/archive/indexer-workspaces-sqlite-gateway-api.md), [`plans/archive/indexer-workspaces-accurate-reporting.md`](../plans/archive/indexer-workspaces-accurate-reporting.md)
