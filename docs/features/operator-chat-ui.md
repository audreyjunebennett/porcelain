...
| **Originated from** | [`plans/archive/operator-chat-ui.md`](../plans/archive/operator-chat-ui.md) |
...
- Delivery plan: [`plans/archive/operator-chat-ui.md`](../plans/archive/operator-chat-ui.md)
